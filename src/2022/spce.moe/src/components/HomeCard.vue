<!-- 
    ...
    File: HomeCard.vue @ https://github.com/owospace/spce.moe
...
.bg {
    ...
    /* This option fixes the weird margin/'invisible' background/body bug whatever */
    margin-bottom: 450px;
}
...
.card:after {
    ...
    background: inherit;
    position: absolute;
    box-shadow: inset 0 0 0 200px #1e1e1e;
    filter: blur(10px);
}
